 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Oct 20 15:47:27 2023
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                EncoderPiero_Final
...
extern void EncoderPiero_Final_Outputs_wrapper(int32_T *pos,
  const real_T *xD);
extern void EncoderPiero_Final_Update_wrapper(int32_T *pos,
  real_T *xD);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  EncoderPiero_Final_Outputs_wrapper(pos, xD);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  EncoderPiero_Final_Update_wrapper(pos, xD);
}
